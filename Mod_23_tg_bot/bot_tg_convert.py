...
def start(message: telebot.types.Message):
    text = 'Приветствую, я бот-конвертер валют! \n\
Увидеть списки всех доступных валют: /values \n\
Чтобы узнать как конвертировать валюту введите команду /help \n'
...
def convert(message: telebot.types.Message):
    try:
       ...
       print(type(amount))
        ...
        text=f'Цена {amount} {quote} в {base} - {total_base*float(amount)} {base}'
